...
function journalEvents() {
  EVENTS.clear();
  for (let entry of JOURNAL) for (let e of entry.events) EVENTS.add(e);
}
...
const JOURNAL = [
  ...
  new Entry(
    ["bread", "pudding", "brushed teeth", "weekend", "touched tree"],
    false
  ),
  ...
  new Entry(
    ["pizza", "brushed teeth", "computer", "work", "touched tree"],
    false
  ),
  ...
  new Entry(
    ["carrot", "ice cream", "brushed teeth", "television", "work"],
    false
  ),
  new Entry(["spaghetti", "nachos", "work"], false),
  new Entry(
    ["cauliflower", "ice cream", "brushed teeth", "cycling", "work"],
    false
  ),
  new Entry(["spaghetti", "peanuts", "computer", "weekend"], true),
  new Entry(
    ["potatoes", "ice cream", "brushed teeth", "computer", "weekend"],
    false
  ),
  ...
  new Entry(
    ["lasagna", "nachos", "brushed teeth", "running", "weekend"],
    false
  ),
  ...
  new Entry(
    ["pizza", "peanuts", "brushed teeth", "television", "weekend"],
    false
  ),
  ...
  new Entry(
    ["spaghetti", "candy", "television", "work", "touched tree"],
    false
  ),
  ...
  new Entry(
    ["lettuce", "peanuts", "brushed teeth", "work", "touched tree"],
    false
  ),
  ...
  new Entry(
    ["cauliflower", "peanuts", "brushed teeth", "cycling", "work"],
    false
  ),
